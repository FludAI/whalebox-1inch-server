// 1inch API Proxy Server - Full serverOld.js logic for Vercel
...
app.get('/', (req, res) => {
  res.json({
    success: true,
    message: 'Whalebox 1inch Server API - Full serverOld.js Logic',
    version: '1.0.0',
    endpoints: [
      'GET /api/health',
      'GET /api/debug', 
      'GET /api/test-auth',
      'GET /api/test-chains',
      'GET /api/test-regular-swap',
      'GET /api/get-real-tokens',
      'POST /api/test-fusion-direct',
      'GET /api/chains',
      'GET /api/tokens/:chainId',
      'GET /api/quote/:chainId',
      'GET /api/swap/:chainId',
      'POST /api/fusion/quote',
      'POST /api/fusion/swap',
      'GET /api/fusion/chains',
      'GET /api/token-addresses'
    ]
  });
});
...
// Export for Vercel (don't use app.listen in Vercel)
module.exports = app;